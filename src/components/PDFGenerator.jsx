...
function PDFGenerator({ activeCount, onPreview, onClear, disabled }) {
  return (
    <div className="sticky top-0 z-20 -mx-4 border-b border-stone-200/70 bg-[rgba(248,244,237,0.86)] px-4 py-3 backdrop-blur-xl sm:mx-0 sm:rounded-[26px] sm:border sm:px-5">
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-stone-500">Ready To Review</p>
          <p className="mt-1 text-sm text-stone-700">{activeCount} active item{activeCount === 1 ? '' : 's'} in this prep sheet</p>
        </div>
